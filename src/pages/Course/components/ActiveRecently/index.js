...
function ActiveRecently({ activities }) {
    return (
                                ...
                                <div key={activity.id} className={cx('render-activity-item')}>
                                    <div className={cx('activity-item')}>
                                        <div className={cx('user-avatar')}>
                                            <img src='https://ngoaingu24h.vn/resources/images/default/default_avatar.png' alt='img' />
                                        </div>
                                        <div className={cx('body')}>
                                            <div>
                                                <div className={cx('user-name')}>{activity.userName}</div>
                                                <div className={cx('title')}>{activity.content}
                                                </div>
                                            </div>
